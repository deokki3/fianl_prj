				...
				<div class="panel panel-inverse">
					...
					<div class="panel-body col-xl-6 col-md-9" style="margin-left:auto; margin-right:auto;">
						<div class="table-responsive">
							...
							<a href="${pageContext.request.contextPath }/admin/community/freeboard_reply?free_board_no=${map.free_board_no}" class="btn btn-sm btn-success w-120px me-1" style="float:right;">답글쓰기</a>
						</div>
    				</div>
					<!-- END panel-body -->
				</div>
