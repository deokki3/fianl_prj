...
<div class="navbar">
	...
	<nav class="site-menu">
		<ul class="nav-ul">
			...
			<li class="has-megamenu" id="shop-li"><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=20000">Shop</a>
				<ul class="mega-menu">
					<li><span class="mega-menu-title">컴퓨터부품</span>
						<ul class="sub-menu">
							<li><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=3">CPU</a></li>
							<li><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=4">메인보드</a></li>
							<li><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=5">RAM</a></li>
							<li><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=6">그래픽카드</a></li>
						</ul>
					</li>
					<li><span class="mega-menu-title">컴퓨터부품</span>
						<ul class="sub-menu">
							<li><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=7">SSD</a></li>
							<li><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=8">HDD</a></li>
							<li><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=9">POWER</a></li>
							
						</ul>
					</li>
					<li><span class="mega-menu-title">주변기기</span>
						<ul class="sub-menu">
							<li><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=10">쿨러</a></li>
							<li><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=11">컨트롤러</a></li>
							<li><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=12">외장하드</a></li>
							<li><a href="${pageContext.request.contextPath }/shop/product_grid?category_id=13">케이블</a></li>
