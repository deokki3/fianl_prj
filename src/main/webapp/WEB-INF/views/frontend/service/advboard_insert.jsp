...
<div class="row">
	...
	<div class="col-lg-8" style="margin-left:auto; margin-right:auto;">
		...
		<form class="row" name="advForm" method="post" action="${pageContext.request.contextPath}/service/advboard_insert">
			<div class="col-md-12">
			...
			<div class="col-12 padding-top-1x">
				...
				<div class="custom-control custom-checkbox d-block">
					<input class="custom-control-input" type="checkbox" name="adv_secret_chk" id="adv_secret_chk">
...
<jsp:include page="/WEB-INF/views/frontend/inc/footer.jsp"/>
	...
	function clickAdd(formName){
		formName.action = "${pageContext.request.contextPath}/service/advboard_insert";
