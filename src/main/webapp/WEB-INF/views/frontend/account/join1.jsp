		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<form class="card" method="post"
					action="${pageContext.request.contextPath }/account/join1">
					<div class="card-body">
						<h4 class="margin-bottom-1x text-center">회원가입 약관</h4>
	<!-- 이용약관 텍스트 시작 -->			
...
2) 시행일자 : 2018년 05월 01일 </textarea>
		...
		<!-- 개인정보 텍스트 시작 끝 -->
						...
						<div class="form-group input-group">
							<input type="checkbox" name="agree" value="true"> 동의합니다 <span style="color:red">(필수)</span>
						</div>
						<div class="text-center text-sm-right">
							<button class="btn btn-primary margin-bottom-none" type="submit">다음 단계</button>
						</div>
					</div>
				</form>
			</div>
