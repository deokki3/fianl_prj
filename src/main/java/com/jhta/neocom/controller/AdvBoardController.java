...
//			System.out.println(map);
		...
		public String advboard_list(@RequestParam(value = "pageNum", defaultValue = "1") 
...
//			System.out.println(map);
	...
	// 견적문의게시판 상세 페이지 이동
		...
		// 견적문의게시판 비밀글 확인
			...
			public String advboard_detailLock(int adv_board_no, Model model, Authentication auth) {
				CustomUserDetails cud = (CustomUserDetails) auth.getPrincipal();
				MemberVo mvo = cud.getMemberVo();
