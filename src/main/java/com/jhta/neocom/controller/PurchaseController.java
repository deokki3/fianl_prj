...
public class PurchaseController {
	...
	public ModelAndView purchase(OrderMainVo vo,String [] product_count,String [] product_id,HttpSession session,Model model) {
		try {
			int mem_no=(Integer)session.getAttribute("mem_no");
			vo.setMem_no(mem_no);
...
/*				vo3.setOrder_no(order_num_update);
				vo3.setMem_no(mem_no);
				System.out.println(vo3);
				odservice.insert(vo3); */
